...
// 🟢 Approach 3 Optimal: --> Reverse Algorithm
...
int main()
{
  ...
  cout << "Array after LEFT rotation(Brute): ";
  for (int x : arr1)
    cout << x << " ";
  cout << endl;
  ...
  cout << "Array after RIGHT rotation(Brute): ";
  for (int x : arr2)
    cout << x << " ";
  cout << endl;
  ...
  // To be implemented: leftRotateOptimal(arr5);
  cout << "Array after LEFT rotation (Optimal): ";
  for (int x : arr5)
    cout << x << " ";
  cout << endl;

  // RIGHT ROTATION (Optimal)
  // To be implemented: rightRotateOptimal(arr6);
  cout << "Array after RIGHT rotation (Optimal): ";
  for (int x : arr6)
    cout << x << " ";
  cout << endl;
}